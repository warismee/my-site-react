    ...
    <div className='exp_container'>
      <div className='exp_cards_hz'>
        <div className='exp_card'>
          ...
          <br/>
          <h4>Member liaison/admin assistant (2022-2023) (volunteering)</h4>
          <h5 className='text-light'>Volunteer Wellington (Wellington, NZ)</h5>
          <br/>
